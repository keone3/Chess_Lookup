		...
		for(let i = 0; i < newGames.length; i++){
			...
			try{
				...
				if('user' in specificMatch['players']['white']){
					...
					if(userName.toUpperCase() == specificMatch['players']['white']['user']['name'].toUpperCase()){
						userColour = 'white'
					...
					if(userName.toUpperCase() == specificMatch['players']['black']['user']['name'].toUpperCase()){
						userColour = 'black'
						opponentColour = 'white'
					}else{
						userColour = 'white'
				...
				opponentName = specificMatch['players'][opponentColour]['user']['name']
				...
				if(userColour == 'white'){
					...
					opponentRating = specificMatch['players']['black']['rating']
				}else{
				...
				currentGame = new Game(-1, 'NA', 'NA', 'NA', 'NA', 'NA', 'NA','NA', 
				'NA', -1, -1, 'NA', 0)
...
function addRows(){
	...
	while(game != null){
		...
		cell = row.insertCell()
		cell.appendChild(document.createTextNode(game.getGame().getDatePlayed()))//dated played
		cell = row.insertCell()
		...
		cell = row.insertCell()
		cell.appendChild(document.createTextNode(game.getGame().getOpeningGeneral()))//opening
		cell = row.insertCell()
